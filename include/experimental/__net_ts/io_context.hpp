...
#ifndef NET_TS_IO_CONTEXT_HPP
#define NET_TS_IO_CONTEXT_HPP
...
public:
   ...
   */
  NET_TS_DECL count_type run_one();
   ...
   * @return The number of handlers that were executed.
   */
  NET_TS_DECL count_type poll_one();
