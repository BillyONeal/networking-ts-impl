...
#ifndef NET_TS_BASIC_STREAM_SOCKET_HPP
#define NET_TS_BASIC_STREAM_SOCKET_HPP
...
public:
  ...
  basic_stream_socket(
      basic_stream_socket<Protocol1 NET_TS_SVC_TARG1>&& other,
...
#endif // NET_TS_BASIC_STREAM_SOCKET_HPP
