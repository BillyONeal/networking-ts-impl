...
#ifndef NET_TS_EXECUTION_CONTEXT_HPP
#define NET_TS_EXECUTION_CONTEXT_HPP
...
public:
   ...
   */
  NET_TS_DECL void notify_fork(fork_event event);
...
protected:
   ...
   */
  NET_TS_DECL service(execution_context& owner);
...
{
public:
  NET_TS_DECL service_already_exists();
};
...
{
public:
  NET_TS_DECL invalid_service_owner();
};
...
#endif // NET_TS_EXECUTION_CONTEXT_HPP
