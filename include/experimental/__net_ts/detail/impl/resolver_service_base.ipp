...
{
public:
  work_io_context_runner(std::experimental::net::v1::io_context_runner& io_context)
    : io_context_(io_context) {}
  void operator()() { io_context_.run(); }
private:
  std::experimental::net::v1::io_context_runner& io_context_;
};
...
resolver_service_base::resolver_service_base(
  ...
  : io_context_impl_(std::experimental::net::v1::use_service<io_context_impl>(io_context)),
    work_io_context_(new std::experimental::net::v1::io_context_runner(-1)),
