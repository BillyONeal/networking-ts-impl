...
#ifndef NET_TS_BUFFER_HPP
#define NET_TS_BUFFER_HPP
...
#  define NET_TS_ENABLE_ARRAY_BUFFER_WORKAROUND
# endif // BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x582))
        // || BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x590))
#endif // defined(NET_TS_HAS_BOOST_WORKAROUND)

#if defined(NET_TS_ENABLE_ARRAY_BUFFER_WORKAROUND)
# include <experimental/__net_ts/detail/type_traits.hpp>
#endif // defined(NET_TS_ENABLE_ARRAY_BUFFER_WORKAROUND)
...
public:
  ...
  mutable_buffer() NET_TS_NOEXCEPT
    : data_(0),
      size_(0)
  {
  }
  ...
  mutable_buffer(void* data, std::size_t size) NET_TS_NOEXCEPT
    : data_(data),
      size_(size)
  {
  }
  ...
  void* data() const NET_TS_NOEXCEPT
  {
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
  ...
  mutable_buffer& operator+=(std::size_t n) NET_TS_NOEXCEPT
  {
...
public:
  ...
  /// Construct a buffer to represent a given memory range.
  const_buffer(const void* data, std::size_t size) NET_TS_NOEXCEPT
    : data_(data),
      size_(size)
  {
  }
  ...
  const_buffer(const mutable_buffer& b) NET_TS_NOEXCEPT
    : data_(b.data()),
      size_(b.size())
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
  ...
  /// Get a pointer to the beginning of the memory range.
  const void* data() const NET_TS_NOEXCEPT
  {
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
    if (size_ && debug_check_)
      debug_check_();
  ...
  /// Move the start of the buffer by the specified number of bytes.
  const_buffer& operator+=(std::size_t n) NET_TS_NOEXCEPT
  {
    std::size_t offset = n < size_ ? n : size_;
...
public:
  ...
  const_iterator begin() const NET_TS_NOEXCEPT
  {
    return &buf_;
  }

  /// Get a random-access iterator for one past the last element.
  const_iterator end() const NET_TS_NOEXCEPT
  {
    return &buf_;
  }
...
#if defined(NET_TS_HAS_DECLTYPE) || defined(GENERATING_DOCUMENTATION)
...
#else // defined(NET_TS_HAS_DECLTYPE) || defined(GENERATING_DOCUMENTATION)
...
#endif // defined(NET_TS_HAS_DECLTYPE) || defined(GENERATING_DOCUMENTATION)
...
inline std::size_t buffer_size(one_buffer,
    Iterator begin, Iterator) NET_TS_NOEXCEPT
{
...
inline std::size_t buffer_size(multiple_buffers,
    Iterator begin, Iterator end) NET_TS_NOEXCEPT
{
 ...
 */
template <typename BufferSequence>
inline std::size_t buffer_size(const BufferSequence& b) NET_TS_NOEXCEPT
{
...
inline mutable_buffer operator+(std::size_t n,
    const mutable_buffer& b) NET_TS_NOEXCEPT
{
  return b + n;
}
...
inline const_buffer operator+(std::size_t n,
    const const_buffer& b) NET_TS_NOEXCEPT
{
  return b + n;
}
...
public:
  ...
  ~buffer_debug_check()
  {
    ...
    iter_ = Iterator();
#endif // defined(NET_TS_MSVC) && (NET_TS_MSVC == 1400)
  }
...
#define NET_TS_MUTABLE_BUFFER mutable_buffer
#define NET_TS_CONST_BUFFER const_buffer
/// Create a new modifiable buffer from an existing buffer.
/**
 * @returns <tt>mutable_buffer(b)</tt>.
 */
inline NET_TS_MUTABLE_BUFFER buffer(
    const mutable_buffer& b) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(b);
}
 ...
 */
inline NET_TS_MUTABLE_BUFFER buffer(const mutable_buffer& b,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(
 ...
 */
inline NET_TS_MUTABLE_BUFFER buffer(void* data,
    std::size_t size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data, size_in_bytes);
}
 ...
 */
inline NET_TS_CONST_BUFFER buffer(const void* data,
    std::size_t size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data, size_in_bytes);
}
...
inline NET_TS_MUTABLE_BUFFER buffer(PodType (&data)[N]) NET_TS_NOEXCEPT
{
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_MUTABLE_BUFFER buffer(PodType (&data)[N],
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data,
...
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(
    const PodType (&data)[N]) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data, N * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(const PodType (&data)[N],
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data,
      N * sizeof(PodType) < max_size_in_bytes
      ? N * sizeof(PodType) : max_size_in_bytes);
}
...
struct buffer_types_base<false>
{
  ...
  typedef NET_TS_MUTABLE_BUFFER container_type;
};
...
struct buffer_types_base<true>
{
  ...
  typedef NET_TS_CONST_BUFFER container_type;
};
...
#else // defined(NET_TS_ENABLE_ARRAY_BUFFER_WORKAROUND)
...
template <typename PodType, std::size_t N>
inline NET_TS_MUTABLE_BUFFER buffer(
    boost::array<PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_MUTABLE_BUFFER buffer(boost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data.c_array(),
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes);
}
...
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(
    boost::array<const PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(boost::array<const PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes);
}
...
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(
    const boost::array<PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(const boost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
...
#if defined(NET_TS_HAS_STD_ARRAY) || defined(GENERATING_DOCUMENTATION)
...
template <typename PodType, std::size_t N>
inline NET_TS_MUTABLE_BUFFER buffer(
    std::array<PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_MUTABLE_BUFFER buffer(std::array<PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes);
}
...
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(
    std::array<const PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(std::array<const PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
...
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(
    const std::array<PodType, N>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline NET_TS_CONST_BUFFER buffer(const std::array<PodType, N>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
...
#endif // defined(NET_TS_HAS_STD_ARRAY) || defined(GENERATING_DOCUMENTATION)
...
inline NET_TS_MUTABLE_BUFFER buffer(
    std::vector<PodType, Allocator>& data) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(
 ...
 */
template <typename PodType, typename Allocator>
inline NET_TS_MUTABLE_BUFFER buffer(std::vector<PodType, Allocator>& data,
    std::size_t max_size_in_bytes) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data.size() ? &data[0] : 0,
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
template <typename PodType, typename Allocator>
inline NET_TS_CONST_BUFFER buffer(
    const std::vector<PodType, Allocator>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(
      data.size() ? &data[0] : 0, data.size() * sizeof(PodType)
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
inline NET_TS_MUTABLE_BUFFER buffer(
    std::basic_string<Elem, Traits, Allocator>& data) NET_TS_NOEXCEPT
{
  return NET_TS_MUTABLE_BUFFER(data.size() ? &data[0] : 0,
...
template <typename Elem, typename Traits, typename Allocator>
inline NET_TS_CONST_BUFFER buffer(
    const std::basic_string<Elem, Traits, Allocator>& data) NET_TS_NOEXCEPT
{
  return NET_TS_CONST_BUFFER(data.data(), data.size() * sizeof(Elem)
#if defined(NET_TS_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
public:
  ...
  typedef NET_TS_CONST_BUFFER const_buffers_type;

  /// The type used to represent the output sequence as a list of buffers.
  typedef NET_TS_MUTABLE_BUFFER mutable_buffers_type;
  ...
  explicit dynamic_string_buffer(std::basic_string<Elem, Traits, Allocator>& s,
      std::size_t maximum_size =
        (std::numeric_limits<std::size_t>::max)()) NET_TS_NOEXCEPT
    : string_(s),
      size_(string_.size()),
  ...
  dynamic_string_buffer(dynamic_string_buffer&& other) NET_TS_NOEXCEPT
   ...
   * and output sequence.
   */
  std::size_t max_size() const NET_TS_NOEXCEPT
  {
    return max_size_;
  }
...
#if defined(NET_TS_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
  /// Move construct a dynamic buffer.
  dynamic_vector_buffer(dynamic_vector_buffer&& other) NET_TS_NOEXCEPT
...
inline dynamic_string_buffer<Elem, Traits, Allocator> dynamic_buffer(
    std::basic_string<Elem, Traits, Allocator>& data,
    std::size_t max_size) NET_TS_NOEXCEPT
{
...
inline dynamic_vector_buffer<Elem, Allocator> dynamic_buffer(
    std::vector<Elem, Allocator>& data) NET_TS_NOEXCEPT
{
...
inline std::size_t buffer_copy(one_buffer, one_buffer,
    ...
    SourceIterator source_begin, SourceIterator) NET_TS_NOEXCEPT
{
...
std::size_t buffer_copy(multiple_buffers, multiple_buffers,
    TargetIterator target_begin, TargetIterator target_end,
    SourceIterator source_begin, SourceIterator source_end) NET_TS_NOEXCEPT
{
  std::size_t total_bytes_copied = 0;
...
inline std::size_t buffer_copy(const MutableBufferSequence& target,
    const ConstBufferSequence& source) NET_TS_NOEXCEPT
{
